package br.ufpe.cin.reuso.delegate
{
	...
	public class LoginDelegate // extends Delegate
	{
		...
		public function Inserir( params:LoginVO ):void
		{
			var token:AsyncToken = this.service.inserir( params );
			token.addResponder( responder );
		}

		public function Excluir( params:LoginVO ):void
		{
			var token:AsyncToken = this.service.remover( params );
			token.addResponder( responder );
		}

		public function Editar( params:LoginVO ):void
		{
			var token:AsyncToken = this.service.atualizar( params );
			token.addResponder( responder );
		}

		public function Pesquisar( params:LoginVO, ordernarPor:String ):void
		{
